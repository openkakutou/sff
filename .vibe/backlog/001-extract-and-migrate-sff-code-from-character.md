...
## Acceptance Criteria
- [ ] Existing v1/v2 parse+serialize+palette functionality is reproduced here with equivalent test coverage
- [ ] No dependency on the `character` module
- [ ] `character`'s own migration item (035) can then depend on this being tagged/released
